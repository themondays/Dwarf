...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      var option_obj = this.form_field.options[option.array_index];
      option_el = document.createElement("li");
      option_el.className = classes.join(" ");
      option_el.style.cssText = option.style;
      option_el.setAttribute("data-option-array-index", option.array_index);
      option_el.innerHTML = option.search_text;
      if ($(option_obj).data('href')) {
        link_el = document.createElement("a");
        link_el.className = "smart-link";
        link_el.href = $(option_obj).data('href');
        link_el.innerHTML = "L";
        link_el.onclick = function(event){
          event.stopPropagation();
          return window.location.href = $(option_obj).data('href');
        };

        option_el.appendChild(link_el);
      }
